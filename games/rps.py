...
def render_board(match: dict) -> str:
    ...
    p1_status = "✅ <b>Chosen</b>" if state["player1_choice"] else "⏳ Choosing..."
    p2_status = "✅ <b>Chosen</b>" if state["player2_choice"] else "⏳ Choosing..."
    lines = [
        ...
        f"👤 @{p2_name}  —  {p2_status}",
        "",
        "⚡ <b>Both pick secretly — reveal when both choose!</b>",
    ]
    return "\n".join(lines)
