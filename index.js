...
app.get("/", (_req, res) => {
  res.send(`
    <html><body style="font-family:sans-serif;text-align:center;padding:50px;background:#0a0a0a;color:#fff">
      <h2>✅ WhatsApp Broadcast Bot v3</h2>
      <p style="color:#4ade80">Bot chal raha hai 🟢 (Baileys — No Chrome)</p>
...
app.listen(PORT, () => {
  console.log(`🌐 Web server ready — port ${PORT}`);
});
...
bot.launch({ dropPendingUpdates: true }).then(() => {
  console.log("✅ WhatsApp Broadcast Bot v3 (Baileys) chal raha hai!");
});
